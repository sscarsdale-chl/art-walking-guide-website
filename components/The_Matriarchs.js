    ...
    <div className="flex flex-col min-h-screen bg-black text-white">
      ...
      <main className="flex flex-col items-center w-full flex-1 px-18 pt-20 text-left">
        <section className="w-full">
          <div className="video-wrapper">
            <ReactPlayer
              ...
              light="/poster/Tim_Nevaquaya.jpg"
            />
          </div>
        ...
        <section className="container mx-auto px-10 mt-5 mb-32">
          <h3 className="uppercase my-1 text-3xl tracking-wider">The Matriarchs</h3>
          <h5 className="my-1 text-xl tracking-wide">by TIM NEVAQUAYA</h5>
          ...
          <img
            ...
            src="/Tim_Nevaquaya_Bio.jpg"
            alt="Choctaw"
          />

          <p>"The Matriarchs" represents the strength of Choctaw women, and especially my grandmother. I hope it inspires future generations of Choctaw people to be strong, walk with dignity, and to keep your families together. That’s what my grandmother and her legacy were about.</p>
        </section>
