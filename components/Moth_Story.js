      ...
      <main className="flex flex-col items-center w-full flex-1 px-18 pt-20 text-left">
        <section className="w-full">
          <img
            ...
            src="/Fire_and_Earth_color_study_Joanna Kaufman.jpg"
            alt="Choctaw"
          />
        </section>
        <section className="container mx-auto px-10 mt-5 mb-32">
          <h3 className="uppercase my-1 text-3xl tracking-wider">Moth Story</h3>
          <h5 className="my-1 text-xl tracking-wide">by JOANNA KAUFMAN</h5>

          <div className="from-base_pink via-base_purple to-base_teal bg-gradient-to-r w-full h-0.5 my-3 block"></div>

          <img
            className="w-auto m-auto flex flex-row mb-10 mt-4"
            src="/Joanna_Kaufman.jpg"
            alt="Choctaw"
          />

          <p>Each panel represents one element through a close-in view of a distinct North American moth wing. Moth wings are like fire, like water, earth, and air. The moth knows change well and goes through a complete metamorphosis from egg to caterpillar and from chrysalis to adult. Ki* weaves a cocoon in silk, making the protective veil that holds the memory of future possible.</p>

          <p>*Ki/kin are used in place of "it" to name a subject and recognize that it is a living being who possesses agency and beingness rather than "it" that only names an object. If we are many kin rather than many "it", life can be held more fully within the call and response, the communion, the polyphony, and the relatives that we truly are.</p>
        </section>
                      ...
                      {({ zoomIn, zoomOut }) => (
                        <React.Fragment>
                          ...
                          <TransformComponent>
                            ...
                            <div id="cavin" className="absolute inline-flex" onClick={() => checkGallery("/Dylan_Cavin_Big_Sky.jpg")} ></div>
                          </TransformComponent>
                        </React.Fragment>
                      )}
                    </TransformWrapper>
