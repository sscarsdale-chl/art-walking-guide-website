    ...
    <div className="flex flex-col min-h-screen bg-black text-white">
      ...
      <main className="flex flex-col items-center w-full flex-1 px-18 pt-20 text-left">
        <section className="container mx-auto px-10 mt-5 mb-32">
          <h3 className="uppercase my-1 text-3xl tracking-wider">Just Like We Remembered</h3>
          <h5 className="my-1 text-xl tracking-wide">by LAURETTA NEWBY-COKER</h5>
          ...
          <img
            ...
            src="/Lauretta_Coker.jpg"
            alt="Choctaw"
          />

          <p>The daydreams, doodles, and disinterest of a young first-grade Lauretta – while alarming to her teacher – were but a small sign of the artistic greatness to come. Newby-Coker taught as an elementary school teacher for 17 years, and as a K-12 art teacher for the past 10. Her passion for creating art for her tribe, the Choctaw Nation, has led to her work being displayed at art shows and venues, in magazines, the Oklahoma State Capitol, the Cowboy Hall of Fame, and the White House in Washington, D.C.</p>
        </section>
