        ...
        <section className="w-full">
          <div className="video-wrapper">
            <ReactPlayer
              ...
              light="/poster/Jane_Semple_Umsted.jpg"
            />
          </div>
        </section>
        <section className="container mx-auto px-10 mt-5 mb-32">
          <h3 className="uppercase my-1 text-3xl tracking-wider">Gorget of the Sun King</h3>
          <h5 className="my-1 text-xl tracking-wide">by JANE UMSTED</h5>
          ...
          <img
            className="w-auto m-auto flex flex-row mb-10 mt-4"
            src="/Jane_Umsted_2.jpg"
            alt="Choctaw"
          />

          <p>Jane Umsted paints with bold images and colors that echo the spirit of the Choctaw people. Having painted, sculpted, and dabbled in many other mediums, Umsted has been influenced by several styles that seek to provide the depth and variety that the spirit of the Choctaw Nation possesses.</p>
        </section>
