        ...
        <section className="w-full">
          <div className="video-wrapper">
            <ReactPlayer
              ...
              light="/poster/Dylan_Cavin.jpg"
            />
          </div>

        </section>
        <section className="container mx-auto px-10 mt-5 mb-32">
          <h3 className="uppercase my-1 text-3xl tracking-wider">Big Sky</h3>
          <h5 className="my-1 text-xl tracking-wide">by DYLAN CAVIN</h5>

          <div className="from-base_pink via-base_purple to-base_teal bg-gradient-to-r w-full h-0.5 my-3 block"></div>

          <p>"Big Sky" is a portrait of a young Choctaw girl. The subject pictured is Cavin’s niece, who is featured in many of his works. Cavin found out early in his art career that subjects with whom he had personal connections produced more rewarding and unique work. "Big Sky" signifies the world and its opportunities that are ahead of the girl.</p>
        </section>
