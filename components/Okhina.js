        ...
        <section className="w-full">
          <div className="video-wrapper">
            <ReactPlayer
              ...
              light="/poster/Diana_Folsom.jpg"
            />
          </div>

        </section>
        <section className="container mx-auto px-10 mt-5 mb-32">
          <h3 className="uppercase my-1 text-3xl tracking-wider">Okhina Apakni</h3>
          <h3 className="uppercase my-1 text-3xl tracking-wider">Okhina - Ohoyo - Yakni Chukvsh</h3>
          <h5 className="my-1 text-xl tracking-wide">by DIANA FOLSOM</h5>

          <div className="from-base_pink via-base_purple to-base_teal bg-gradient-to-r w-full h-0.5 my-3 block"></div>

          <p>Folsom’s method of painting provides not only an element of surprise but a natural flow of subtly blended composition that seems to have occurred without human intervention. She pours acrylic paint in layers over a textured surface in a several-month process. After each layer, she studies the result of her recent pour and only continues when the next step becomes clear.</p>
        </section>
