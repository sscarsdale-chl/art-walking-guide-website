        ...
        <section className="w-full">
          <div className="video-wrapper">
            <ReactPlayer
              ...
              light="/poster/DG_Smalling.jpg"
            />
          </div>
        </section>
        <section className="container mx-auto px-10 mt-5 mb-32">
          <h3 className="uppercase my-1 text-3xl tracking-wider">Football, Baseball, Boxing and Ice Hockey</h3>
          <h5 className="my-1 text-xl tracking-wide">by DG SMALLING</h5>
        </section>
