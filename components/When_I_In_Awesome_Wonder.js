      ...
      <main className="flex flex-col items-center w-full flex-1 px-18 pt-20 text-left">
        <section className="w-full">
          <img
            ...
            src="/Linda_Bailey_When_I_In_Awesome_Wonder.jpg"
            alt="Choctaw"
          />
        </section>
        <section className="container mx-auto px-10 mt-5 mb-32">
          <h3 className="uppercase my-1 text-3xl tracking-wider">When I in Awesome Wonder</h3>
          <h5 className="my-1 text-xl tracking-wide">by LINDA BAILEY</h5>
          ...
          <img
            ...
            src="/Linda_Bailey.png"
            alt="Choctaw"
          />

          <p>Linda Bailey is an internationally selling artist living in North Carolina. She has had a lifetime of passion for the interplay of light and color in the world, which led her to the discovery of her own talent and her life’s focus of creating art. Bailey’s art subject is often focused on themes of faith, hope, love, power, redemption, light, and strength, and often inspired by song titles such as "How Great Thou Art." Seeking to give thanks and emulate God and his glory, Bailey believes her purpose in life is to praise him with her talents that he has blessed her with.</p>
        </section>
