      ...
      <main className="flex flex-col items-center w-full flex-1 px-18 pt-20 text-left">
        <section className="w-full">
          <img
            ...
            src="/Chapel_Ceiling_Choctaw_Hospital.jpg"
            alt="Choctaw"
          />
        </section>
        <section className="container mx-auto px-10 mt-5 mb-32">
          <h3 className="uppercase my-1 text-3xl tracking-wider">Choctaw Nation Hospital</h3>
          <h5 className="my-1 text-xl tracking-wide">by GERALD HILL</h5>
          ...
          <p>For over 40 years, back-road America has been the subject of Gerald Hill’s photography journey. As a tribal member, the priority of quality healthcare, good education, commitment to help our fellow man, and a foundation of faith has demonstrated to his family for generations what life is about. "The photographs I’ve taken in the Choctaw Nation have deep personal roots in how I perceive adversity, perseverance, and the striving to overcome every obstacle."</p>
        </section>
