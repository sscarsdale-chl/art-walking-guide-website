      ...
      <main className="flex flex-col items-center w-full flex-1 px-18 pt-20 text-left">
        <section className="w-full">
          <img
            ...
            src="/Wani_Marshall_Ishki.jpg"
            alt="Choctaw"
          />
        </section>
        <section className="container mx-auto px-10 mt-5 mb-32">
          <h3 className="uppercase my-1 text-3xl tracking-wider">Ishki</h3>
          <h5 className="my-1 text-xl tracking-wide">by WANI MARSHALL</h5>
          ...
          <img
            ...
            src="/Wani_Marshall.jpg"
            alt="Choctaw"
          />

          <p>Wani Marshall is a working artist and art teacher living in Fort Worth, Texas. When she’s not with elementary schoolers, she’s busy working on jewelry or painting canvases. Her Choctaw heritage comes from her maternal side; her great grandfather, Benjamin Hampton, proudly served as one of the 19 original Code Talkers. Marshall celebrates her heritage with her husband of 28 years and three daughters.</p>
        </section>
