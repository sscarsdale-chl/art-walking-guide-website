      ...
      <main className="flex flex-col items-center w-full flex-1 px-18 pt-20 text-left">
        <section className="w-full">
          <img
            ...
            src="/Connie_Phillips_Series.jpg"
            alt="Choctaw"
          />
        </section>
        <section className="container mx-auto px-10 mt-5 mb-32">
          <h3 className="uppercase my-1 text-3xl tracking-wider">Dusk & Dawn</h3>
          ...
          <img
            ...
            src="/Connie_Phillips.jpg"
            alt="Choctaw"
          />

          <p>Phillips says that all her art begins as inspiration. Her revelation often emerges as a woman or a landscape. In this piece, "Dawn" and "Dusk" represent the circle of life. As dusk falls, dawn rises, giving us another chance to be a better servant to God and our people. Because we can never know when our circle will end, we can only choose the path of redemption through His light.</p>
        </section>
